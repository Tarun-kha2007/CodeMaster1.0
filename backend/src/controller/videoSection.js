...
cloudinary.config({
  cloud_name:"dxqqhx0ek",
  api_key: "191536962552488",
  api_secret: "BA45V7OJefM4Qmt42QdCVBnkJlI"
});
...
const generateUploadSignature = async (req, res) => {
  try {
    ...
    const publicId = `codemaster-solutions/${problemId}/${userId}_${timestamp}`;
    ...
    res.json({
      ...
      api_key: "191536962552488",
      cloud_name: "dxqqhx0ek",
      upload_url: `https://api.cloudinary.com/v1_1/dxqqhx0ek/video/upload`,
    });
